...
def test_job_details(client, default_login, default_repo, default_build,
                     default_job, default_repo_access):
    resp = client.get('/api/repos/{}/builds/{}/jobs/{}'.format(
...
def test_update_job_to_finished(client, mocker, default_login, default_repo,
                                default_build, default_job,
                                default_repo_access):
...
def test_update_job_to_in_progress(client, mocker, default_login, default_repo,
                                   default_build, default_job,
                                   default_repo_access):
    assert default_job.result != Result.failed
