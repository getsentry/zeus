...
def test_grants_repo_access(client, mocker, db_session, responses,
                            default_repo, default_user, default_identity):
    responses.add(
        responses.GET,
...
def test_revokes_repo_access(client, mocker, db_session, responses,
                             default_repo, default_repo_access, default_user, default_identity):
    responses.add(
        responses.GET,
        'https://api.github.com/user/orgs',
        json=[{
...
def test_updates_repo_access(client, mocker, db_session, responses,
                             default_repo, default_repo_access, default_user, default_identity):
    responses.add(
        responses.GET,
        'https://api.github.com/user/orgs',
