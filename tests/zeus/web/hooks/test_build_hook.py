...
def test_new_build(client, default_revision, default_repo, default_hook):
    build_xid = "2"
    ...
    resp = client.post(path, json={"ref": default_revision.sha, "label": "test build"})
...
def test_existing_build(client, default_revision, default_repo, default_hook):
