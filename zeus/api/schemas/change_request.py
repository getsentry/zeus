...
class ChangeRequestSchema(Schema):
    ...
    head_revision = fields.Nested(RevisionSchema(), allow_none=True)
    parent_revision = fields.Nested(RevisionSchema(), required=True)
...
class ChangeRequestCreateSchema(Schema):
    ...
    head_revision_sha = RevisionRefField(allow_none=True)
    parent_revision_sha = RevisionRefField(required=True)
