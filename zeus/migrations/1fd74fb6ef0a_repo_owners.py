...
def upgrade():
    ...
    op.add_column('repository', sa.Column('owner_name', sa.String(length=200), nullable=False))
    op.create_unique_constraint('unq_repo_external_id', 'repository', ['provider', 'external_id'])
