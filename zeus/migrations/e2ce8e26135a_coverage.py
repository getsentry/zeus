...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('diff_lines_covered',
                  sa.Integer(), nullable=True),
        sa.Column('diff_lines_uncovered',
                  sa.Integer(), nullable=True),
        ...
        sa.UniqueConstraint(
            'job_id', 'filename', name='unq_job_filname')
    )
    op.create_index(op.f('ix_filecoverage_repository_id'),
                    'filecoverage', ['repository_id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_filecoverage_repository_id'),
                  table_name='filecoverage')
