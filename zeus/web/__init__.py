...
app.add_url_rule(
    "/auth/github/complete", view_func=v.GitHubCompleteView.as_view("github-complete")
)
app.add_url_rule(
...
app.add_url_rule(
    "/hooks/<hook_id>/<signature>/builds/<build_xid>",
    view_func=h.BuildHook.as_view("build-hook"),
)
app.add_url_rule(
...
app.add_url_rule(
    "/hooks/<hook_id>/<signature>/change-requests/<cr_xid>",
    view_func=h.ChangeRequestHook.as_view("change-request-hook"),
)
